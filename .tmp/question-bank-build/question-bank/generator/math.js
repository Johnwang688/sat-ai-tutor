...
exports.mathQuestionBankConfig = void 0;
exports.generateLinearEquationsInOneVariableQuestions = generateLinearEquationsInOneVariableQuestions;
exports.generateLinearEquationsInTwoVariablesQuestions = generateLinearEquationsInTwoVariablesQuestions;
exports.generateLinearFunctionsQuestions = generateLinearFunctionsQuestions;
exports.generateSystemsOfTwoLinearEquationsQuestions = generateSystemsOfTwoLinearEquationsQuestions;
exports.generateLinearInequalitiesQuestions = generateLinearInequalitiesQuestions;
exports.generateEquivalentExpressionsQuestions = generateEquivalentExpressionsQuestions;
exports.generateNonlinearEquationsQuestions = generateNonlinearEquationsQuestions;
exports.generateNonlinearFunctionsQuestions = generateNonlinearFunctionsQuestions;
exports.generateRatiosRatesAndUnitsQuestions = generateRatiosRatesAndUnitsQuestions;
exports.generatePercentagesQuestions = generatePercentagesQuestions;
exports.generateOneVariableDataQuestions = generateOneVariableDataQuestions;
exports.generateTwoVariableDataQuestions = generateTwoVariableDataQuestions;
exports.generateProbabilityQuestions = generateProbabilityQuestions;
exports.generateInferenceAndMarginQuestions = generateInferenceAndMarginQuestions;
exports.generateEvaluatingStatisticalClaimsQuestions = generateEvaluatingStatisticalClaimsQuestions;
exports.generateAreaAndVolumeQuestions = generateAreaAndVolumeQuestions;
exports.generateLinesAnglesAndTrianglesQuestions = generateLinesAnglesAndTrianglesQuestions;
exports.generateRightTrianglesAndTrigonometryQuestions = generateRightTrianglesAndTrigonometryQuestions;
exports.generateCirclesQuestions = generateCirclesQuestions;
exports.generateMathQuestionsForConcept = generateMathQuestionsForConcept;
exports.generateMathQuestionBank = generateMathQuestionBank;
exports.getMathQuestionBankManifest = getMathQuestionBankManifest;
const core_concepts_1 = require("../../taxonomy/core-concepts");
const sectionSlug = "math";
const sectionName = "Math";
...
function getMathConceptMeta(conceptSlug) {
    const concept = core_concepts_1.canonicalConcepts.find((item) => item.slug === conceptSlug && item.sectionSlug === sectionSlug);
    if (!concept) {
...
function bandForIndex(orderIndex) {
    return difficultyBands[orderIndex] ?? "medium";
}
function difficultyFromBand(band, orderIndex) {
    if (band === "easy") {
...
function normalizeAnswerChoices(correctChoice, distractors, seed) {
...
function buildQuestion(meta, input) {
    const { choices, correctIndex } = normalizeAnswerChoices(input.correctChoice, input.distractors, input.orderIndex);
    return {
...
function makeQuestionSeries(meta, generator) {
...
function intervalString(lower, upper, includeLower, includeUpper) {
...
function numericWrongs(answer, seed) {
    return [
...
function pairWrongs(answer, seed) {
    const [x, y] = answer;
    return [
...
function seriesMeta(slug) {
    return getMathConceptMeta(slug);
}
function generateLinearEquationsInOneVariableQuestions(meta) {
...
function generateLinearEquationsInTwoVariablesQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateLinearFunctionsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateSystemsOfTwoLinearEquationsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateLinearInequalitiesQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateEquivalentExpressionsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateNonlinearEquationsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateNonlinearFunctionsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateRatiosRatesAndUnitsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generatePercentagesQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateOneVariableDataQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateTwoVariableDataQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateProbabilityQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateInferenceAndMarginQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateEvaluatingStatisticalClaimsQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateAreaAndVolumeQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateLinesAnglesAndTrianglesQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateRightTrianglesAndTrigonometryQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
function generateCirclesQuestions(meta) {
    return makeQuestionSeries(meta, (orderIndex, difficultyBand, difficulty) => {
        const seed = Math.floor(orderIndex / 5);
        switch (orderIndex % 5) {
            case 0: {
...
const mathQuestionGeneratorMap = {
    ...
    "nonlinear-equations-in-one-variable-and-systems-of-equations-in-two-variables": generateNonlinearEquationsQuestions,
    ...
    "one-variable-data-distributions-and-measures-of-center-and-spread": generateOneVariableDataQuestions,
    ...
    "evaluating-statistical-claims-observational-studies-and-experiments": generateEvaluatingStatisticalClaimsQuestions,
...
exports.mathQuestionBankConfig = mathConceptSlugs.map((conceptSlug) => {
...
function generateMathQuestionsForConcept(conceptSlug) {
    const meta = seriesMeta(conceptSlug);
    return mathQuestionGeneratorMap[conceptSlug](meta);
}
function generateMathQuestionBank() {
    return exports.mathQuestionBankConfig.flatMap((entry) => entry.generator(seriesMeta(entry.conceptSlug)));
}
function getMathQuestionBankManifest() {
    return exports.mathQuestionBankConfig.map((entry) => ({
